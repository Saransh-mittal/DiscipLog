...
const theme: WorldTheme = {
  ...
  border: "oklch(0.55 0.06 75 / 18%)",
  borderRadius: "10px",
  shadow: "none",
  shadowCard: "none",
  textPrimary: "oklch(0.85 0.012 75)",
  textSecondary: "oklch(0.62 0.008 72)",
  textMuted: "oklch(0.42 0.006 72)",
  ...
  headerBorder: "oklch(0.55 0.06 75 / 8%)",
  tabText: "oklch(0.42 0.006 72)",
  tabActiveText: "oklch(0.78 0.025 75)",
  tabActiveBg: "transparent",
  tabActiveBorder: "oklch(0.65 0.07 75 / 12%)",
};
